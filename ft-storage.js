...
// Abstração: Firebase Firestore (quando disponível) + LocalStorage como fallback/cache.
 ...
 * v1.1: inclui coleção 'preparos'.
 */
export async function sincronizarLocalParaFirebase() {
    if (!fbIsAvailable()) return;
    // v1.1: 'preparos' adicionado à lista de coleções sincronizadas.
